...
function Login() {
  ...
  async function registerForm() {
    ...
    if (toRegister.pass !== toRegister.repeatPass) {
      ...
      if (
        toRegister.user.length > 0 &&
        toRegister.pass.length > 0 &&
        toRegister.repeatPass.length > 0
      ) {
        const response = await Axios.post(serverUrl + '/registerUser', {
          toRegister,
        });
        ...
        {isLoggedIn ? (
          ...
          <div>
            <form id='loginForm' action='submit'>
              ...
              <h3 className='logName' value={toLogin.user}>
                {toLogin.user}
              </h3>
              <br />
              <input
              ...
              ></input>
              <br />
              <h3 className='loginButtonLogin' type='submit' onClick={logar}>
                Login
              </h3>
              <br />
              <h5
          ...
          <div>
            ...
            <h3 className='logName' value={toRegister.user}>
              {toRegister.user}
            </h3>
            <br />
            <input
            ...
            />
            <br />
            <h3 className='loginButtonLogin' onClick={registerForm}>
              Register
            </h3>
            <br />
            <h3
              className='regButtonsBack'
              onClick={() => {
                setLogOrReg('choose');
              }}
            >
