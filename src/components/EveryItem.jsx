                    ...
                    <div className="descDiv">
                        ...
                        <div className="comprarAgora">
                            <div className="quantidadeParaComprar">
                                ...
                                <span> </span>
                                <button value={props.item.estoque} href={props.item.productPrice} onClick={addItem} name={props.item._id} 
                            ...
                            <div className="aboutEveryItem">
                                <h4>Sobre:</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque a interdum nunc, at laoreet lacus. Cras vitae velit sapien. Sed ornare congue sapien hendrerit vehicula. Nam sodales purus tellus, ac pretium metus porttitor vitae. Aenean viverra fringilla pharetra. Pellentesque nec malesuada mauris. Mauris eleifend quam vel ultrices tristique.</p>
                                <h4>Características:</h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque a interdum nunc, at laoreet lacus. Cras vitae velit sapien.</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. .</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque a interdum nunc, at laoreet lacus. Cras.</p>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque a interdum nunc, at laoreet lacus. Cras vitae velit sapien.</p>
                            </div>
                        </div>
                    </div>
